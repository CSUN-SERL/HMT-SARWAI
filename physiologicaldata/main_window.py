...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gaze_output_frame = QtWidgets.QGraphicsView(self.centralwidget)
        self.gaze_output_frame.setGeometry(QtCore.QRect(10, 320, 411, 301))
        self.gaze_output_frame.setObjectName("gaze_output_frame")
